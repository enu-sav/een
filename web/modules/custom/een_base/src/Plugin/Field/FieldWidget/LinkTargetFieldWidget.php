...
namespace Drupal\een_base\Plugin\Field\FieldWidget;
...
/**
 * Plugin implementation of the 'een_link_target_field_widget' widget.
 *
 * @FieldWidget(
 *   id = "een_link_target_field_widget",
 *   label = @Translation("EEN - Link with target"),
 *   field_types = {
 *     "link"
 *   }
 * )
